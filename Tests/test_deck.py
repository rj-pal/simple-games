...
class TestCardQueue:
    ...
    def test_cardqueue_remove_from_top(self):
        """Test removing from the top of the queue (FIFO)."""
        queue = CardQueue()
        card1 = Card("S", 5)
        card2 = Card("H", 10)
        queue.add_to(card1)
    ...
    def test_cardqueue_get_card_in_play_empty(self):
        """Test get_card_in_play on empty queue returns head card."""
        queue = CardQueue()
        assert queue.get_card_in_play().value == 0  # Blank card head

    def test_cardqueue_get_card_in_play_with_cards(self):
        """Test get_card_in_play returns the tail card."""
        queue = CardQueue()
        card1 = Card("S", 5)
        card2 = Card("H", 10)
        queue.add_to(card1)
    ...
    def test_cardqueue_fifo_order(self):
...
class TestCardStack:
    ...
    def test_cardstack_add_invalid_type(self):
        ...
        stack = CardStack()
        with pytest.raises(TypeError):
            stack.add_to("not a card")

    def test_cardstack_remove_from_top(self):
        """Test removing from top of stack (LIFO)."""
        stack = CardStack()
        card1 = Card("S", 5)
        card2 = Card("H", 10)
        stack.add_to(card1)
    ...
    def test_cardstack_get_card_in_play_empty(self):
        """Test get_card_in_play on empty stack returns head card."""
        stack = CardStack()
        assert stack.get_card_in_play().value == 0
