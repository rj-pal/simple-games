...
BOARDLINE_CONNECT4_THIN = (" -" * 5 + " - +") * 5 + " - " * 6 + "-" # for Connect 4 alternative version

# List of single-digit column names for Connect 4.
column_names = ["1", "2", "3", "4", "5", "6", "7"]
# List of full word column names for Connect 4.
column_names_full_word = ["ONE", "TWO", "THREE", "FOUR", "FIVE", "SIX", "SEVEN"]

board_length = len(BOARDLINE_CONNECT4) # This constant stores the calculated length of BOARDLINE_CONNECT4 for seven column game configs.
#
