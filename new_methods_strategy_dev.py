...
print(test.board.get_diagonal_line(5, -1, 4,"left"))
# print("OUT OF BOUNDS OR NOT")
print(test.board.get_diagonal_line(8, 4, 2,"right"))
# print("LEFT TEST")
# for i in range(test.board.columns):
#     print(test.board.get_diagonal_line(2,i,3,"left"))

# print("RIGHT TEST")
# for i in range(test.board.columns):
#     print(test.board.get_diagonal_line(2,i,3,"right"))
exit()
